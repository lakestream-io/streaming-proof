 ...
 * driver.createTopic("test-topic", 8, Map.of("unclean.leader.election.enable", "true"));
 ...
 * }</pre>
 *
 * @see io.lakestream.streaming.proof.driver.kafka.KafkaAtLeastOnceProofProducer
 * @see io.lakestream.streaming.proof.driver.kafka.KafkaAtLeastOnceProofConsumer
 * @see io.lakestream.streaming.proof.driver.kafka.KafkaProofDriver
 */
