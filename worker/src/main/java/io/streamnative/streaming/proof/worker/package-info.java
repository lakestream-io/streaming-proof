 ...
 * <p>Key components:
 * <ul>
 *   <li>{@link io.streamnative.streaming.proof.worker.Worker} - Container for producer and consumer groups</li>
 *   <li>{@link io.streamnative.streaming.proof.worker.ProofProducers} - Group of producer instances</li>
 *   <li>{@link io.streamnative.streaming.proof.worker.ProofConsumers} - Group of consumer instances</li>
 *   <li>{@link io.streamnative.streaming.proof.worker.DefaultMessageListener} - Sequence tracking implementation</li>
 *   <li>{@link io.streamnative.streaming.proof.worker.DriverCache} - Messaging system client cache</li>
 * </ul>
 *
 ...
 * @see io.streamnative.streaming.proof.worker.WorkerHandler
